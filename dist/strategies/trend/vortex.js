...
class VortexStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'VORTEX';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.vortexStrategy)(asset, this.config);
    }
}
exports.VortexStrategy = VortexStrategy;
