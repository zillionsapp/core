...
class StochStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'STOCH';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.stochStrategy)(asset, this.config);
    }
}
exports.StochStrategy = StochStrategy;
