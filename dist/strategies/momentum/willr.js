...
class WillRStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'WILLR';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.willRStrategy)(asset, this.config);
    }
}
exports.WillRStrategy = WillRStrategy;
