...
class AoStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'AO';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.aoStrategy)(asset, this.config);
    }
}
exports.AoStrategy = AoStrategy;
