...
class CmfStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'CMF';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.cmfStrategy)(asset, this.config);
    }
}
exports.CmfStrategy = CmfStrategy;
