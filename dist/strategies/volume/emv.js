...
class EmvStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'EMV';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.emvStrategy)(asset, this.config);
    }
}
exports.EmvStrategy = EmvStrategy;
