...
class BbStrategy extends base_strategy_1.BaseLibraryStrategy {
    constructor() {
        super(...arguments);
        this.name = 'BB';
        this.config = {};
    ...
    getActions(asset) {
        return (0, indicatorts_1.bbStrategy)(asset, this.config);
    }
}
exports.BbStrategy = BbStrategy;
